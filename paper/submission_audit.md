...
| Future Work | Present | `main.tex` | Specifies the complete corrective rerun, second-region validation, issue-time event sources, and learned retrieval as future extensions. |
