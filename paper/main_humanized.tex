...
The explanation module is based on signed local contributions provided by the 24 direct models, weather flags, top three retrieved windows, recent event records, calendar context, forecast direction, and component level drift evidence. Its diagnostic uncertainty scale is defined by equation~\eqref{eq:uncertainty_proxy}.
\begin{equation}
u_t^{\mathrm{diag}}=
