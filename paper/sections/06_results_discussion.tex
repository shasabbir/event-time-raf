...
obtains MSE 26.712 and MAE 3.149. Therefore, the final run supports a modest
...
pass the minimum-size gate. The event subset has lower MSE than the non-event
...
\caption{Representative forecast case generated from the final test run.}
...
final run produced 7,199 explanation records in
...
The final publication-mode run completed in 1,576.9 seconds in a Kaggle Linux
notebook environment using Python 3.12.13. The recorded package versions include
...
\begin{table}[!t]
\centering
\caption{Final-Run Computational and Reproducibility Summary}
...
Platform & Kaggle Linux notebook \\
Python & 3.12.13 \\
