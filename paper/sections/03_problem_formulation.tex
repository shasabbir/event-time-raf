...
\end{equation}
where $L$ is the lookback length. Let $W_t$ denote weather covariates aligned with the lookback window, $C_t$ denote calendar features, and $E_t$ denote event context obtained from the NOAA Storm Events knowledge base. The target is the future PM2.5 sequence
\begin{equation}
