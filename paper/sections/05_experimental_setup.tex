...
Table~\ref{tab:planned_data} lists the planned data sources and feature groups. The initial study period is 2019--2024, subject to PM2.5 target coverage and event-data audit results. The preferred PM2.5 target is a single high-coverage AQS site; if no single site passes the coverage gate, the audited fallback is the hourly median across official Los Angeles County AQS monitors.
