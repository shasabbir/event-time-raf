...
Table~\ref{tab:planned_data} lists the planned data sources and feature groups. The final dataset coverage will depend on the actual availability of Dhaka PM2.5 measurements and event records.
...
The initial task is 24-hour-ahead PM2.5 forecasting with a 168-hour lookback window. The planned split uses the earliest 70\% of observations for training, the next 15\% for validation, and the latest 15\% for testing. Random splitting will not be used.
