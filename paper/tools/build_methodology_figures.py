...
def pipeline_figure(path: Path) -> None:
    ...
    s.rect(320, 254, 194, 88, BLUE, ["Causal feature", "construction"], "q_t in R^86")
    ...
    s.rect(898, 102, 248, 88, PINK, ["Direct XGBoost", "24 horizon heads"], "B x 152 -> B x 24")
    s.rect(898, 238, 248, 88, PINK, ["Frozen Chronos-Bolt", "+ forecast fusion"], "B x 168 -> B x 24")
    s.rect(898, 374, 248, 74, GREEN, ["Exploratory drift", "selection audit"], "M04/A01 by D_t")
...
def context_figure(path: Path) -> None:
    ...
    s.rect(546, 222, 170, 74, GOLD, ["Event counts, active", "states, burst ratio"], "40 features")
    ...
    s.rect(406, 444, 250, 76, GREEN, ["Origin context vector"], "q_t in R^86")
    ...
    s.rect(812, 94, 330, 76, GREEN, ["Aligned hourly panel"], "T x (1 + 86)")
...
def forecast_figure(path: Path) -> None:
    ...
    s.rect(54, 180, 234, 64, BLUE, ["Origin context"], "q_t: B x 86")
    ...
    s.rect(394, 92, 218, 88, PINK, ["24 direct XGBoost", "regressors (M09)"], "B x 152 -> B x 24")
    s.rect(636, 92, 186, 88, GREEN, ["Exploratory selector", "M04 / A01"], "D_t in {0,1}")
    ...
    s.text(604, 552, "Three reported prediction variants; M12 remains exploratory", "small", anchor="middle")
