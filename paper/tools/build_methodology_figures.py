...
def pipeline_figure(path: Path) -> None:
    ...
    s.rect(52, 340, 184, 76, BLUE, ["NOAA Storm Events", "verified records"], "127 event days")
...
def context_figure(path: Path) -> None:
    ...
    s.rect(52, 320, 204, 72, BLUE, ["NOAA events", "verified records"], "127 event days")
    s.rect(52, 432, 204, 88, GRAY, ["Availability and", "duplicate checks"], "retrospective timing")
